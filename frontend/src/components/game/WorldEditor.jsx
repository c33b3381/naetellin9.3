...
import { 
  ...
  Shovel, Pickaxe, Key, Door, Target
} from 'lucide-react';
...
const OBJECT_CATEGORIES = {
  ...
  buildings: {
    ...
    types: {
      ...
      castle_gate: { label: 'Castle Gate', icon: Door },
  ...
  walls_fences: {
    ...
    types: {
      ...
      fence_wood_gate: { label: 'Wood Gate', icon: Door },
      ...
      fence_iron_gate: { label: 'Iron Gate', icon: Door },
      palisade: { label: 'Palisade', icon: Fence },
      palisade_gate: { label: 'Palisade Gate', icon: Door },
      hedge: { label: 'Hedge', icon: Leaf },
      hedge_archway: { label: 'Hedge Archway', icon: Door },
      city_wall: { label: 'City Wall', icon: Castle },
      city_gate: { label: 'City Gate', icon: Door },
  ...
  props: {
    ...
    types: {
      ...
      archway: { label: 'Stone Archway', icon: Door },
  ...
  dungeon: {
    ...
    types: {
      ...
      prison_door: { label: 'Prison Door', icon: Door },
      ...
      dungeon_door: { label: 'Dungeon Door', icon: Door },
      dungeon_gate: { label: 'Dungeon Gate', icon: Door },
      ...
      trap_door: { label: 'Trap Door', icon: Door },
      secret_passage: { label: 'Secret Passage', icon: Door },
  ...
  military: {
    ...
    types: {
      ...
      battering_ram: { label: 'Battering Ram', icon: Door },
